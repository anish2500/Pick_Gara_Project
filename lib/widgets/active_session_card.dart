        ...
        children: [
          ...
          Row(
            children: [
              const Icon(Icons.circle,
                  color: AppColors.success, size: AppSpacing.iconXS),
              const SizedBox(width: AppSpacing.sm),
              Expanded(
                child: Text(sessionName, style: AppTextStyles.titleL),
              ),
            ],
          ),
          ...
          Row(
            children: [
              const Icon(Icons.access_time_rounded,
                  size: AppSpacing.iconXS, color: AppColors.textSecondary),
          ...
          Row(
            children: [
              ...
              ...avatarAssets.take(3).map((a) => Align(
                    widthFactor: 0.65,
                    child: CircleAvatar(
                      radius: 14,
...
class _VoteRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final frac = item.totalVotes > 0
        ? item.voteCount / item.totalVotes
        : 0.0;
    ...
    return Row(
      children: [
        ...
        Expanded(
          flex: 3,
          child: Text(item.name, style: AppTextStyles.bodyM),
        ),
