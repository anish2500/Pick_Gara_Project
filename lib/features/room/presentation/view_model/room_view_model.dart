...
final roomViewModelProvider =
    NotifierProvider<RoomViewModel, RoomState>(RoomViewModel.new);
...
class RoomViewModel extends Notifier<RoomState> {
  ...
  Future<void> createRoom(String name, String category) async {
    ...
    final result = await ref.read(createRoomUsecaseProvider).call(
          CreateRoomUsecaseParams(name: name, category: category),
        );
